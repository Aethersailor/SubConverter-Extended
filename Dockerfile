...
LABEL \
  ...
  org.opencontainers.image.url="https://github.com/chenglong-do/SubConverter-Extended" \
  org.opencontainers.image.source="https://github.com/chenglong-do/SubConverter-Extended" \
